...
<html lang="en">
  ...
  >
    <!-- Navigation -->
    <header class="my-4 w-48 hidden shrink-0 pl-4 xl:ml-40 flex-col gap-8 sm:flex justify-between">
    ...
    <main class="flex grow flex-col gap-4 overflow-y-auto px-4 -mx-4 py-4">
      ...
      >
        ...
        <form action="" class="grow">
          <label class="sr-only" for="post"></label>
          <textarea
      ...
      <ol class="mt-4">
            ...
            <div class="border-pixl-light/10 border-b pb-5">
              ...
              <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                  ...
                  <p>
                    <a
                      class="hover:text-pixl-light/60 text-pixl-light/40 text-xs"
                      href="/profile"
                      >@mmich_jj</a
                    >
                  </p>
              ...
              <div class="mt-6 flex items-center justify-between gap-4">
                <div class="flex items-center gap-8">
                  ...
                  <div class="flex items-center gap-1">
                    <button aria-label="Like button" class="hover:text-pixl">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        class="h-[17px]"
              ...
              <!-- Reply form -->
              <div class="border-pixl-light/10 mt-8 flex items-start gap-4 border-t bg-pixl-light/3 p-4">
        <a href="/profile" class="shrink-0">
          <img
            src="/images/adrian.png"
            alt="Avatar for Adrian"
        ...
        <form action="" class="grow">
          ...
          <div class="flex items-center justify-between gap-4">
            ...
            <ol>
              ...
              <li class="relative flex items-start gap-4 pt-4 group/li">
                <!-- Line through -->
                 <div aria-hidden="true" class="absolute top-0 left-5 w-px h-full group-last/li:h-4 bg-pixl-light/10"></div>
                <a href="/profile" class="shrink-0 isolate">
                  <img
                    src="/images/calum.png"
                    alt="Avatar for Calum"
                    class="size-10 object-cover"
                    />
                </a>
          <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
            <div class="flex items-center justify-between gap-4">
              <div class="flex items-center gap-2.5">
                <p><a class="hover:underline" href="/profile">Calum</a></p>
