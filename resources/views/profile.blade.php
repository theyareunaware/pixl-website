...
<body
    ...
    <!-- Navigation -->
    <header
        class="my-4 w-48 hidden shrink-0 pl-4 xl:ml-40 flex-col gap-8 sm:flex justify-between">
        <div class="overflow-y-auto ">
            <!-- Logo -->
            <a href="/"><svg class="h-8" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 182 61" fill="none">
                    <path fill="#EEE"
                    ...
                    <path fill="#EEE" d="M181.499 50.416h-10.083V60.5h10.083V50.416Z">
                    </path>
                </svg></a>
            <!-- Navigation -->
            <nav class="mt-10">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex gap-3.5">
                <a href="/profile" class="shrink-0">
                    <img src="/images/adrian.png" alt="Avatar for Adrian"
    ...
    <!-- Content -->
    <main class="flex grow flex-col gap-4 overflow-y-auto px-4 -mx-4 py-4">
        <a href="/feed" class="group flex items-baseline gap-1.5 group">
            <svg class="size-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12"
                fill="none">
        ...
        <!-- Profile Header -->
        <header>
            <img src="/images/cover.png" alt="Pixel art of knight">
            <div class="flex flex-wrap items-end gap-4 md:-mt-16 -mt-10 justify-between">
                <div class="flex gap-4 items-end">
                    <img src="/images/adrian.png" alt="Avatar for Adrian"
                        class="md:size-32 size-20 object-cover">
            ...
            <div class="mt-8 [&_a]:text-pixl [&_a]:hover:underline">
                <p>I design <a href="#">@Figma</a> so hit me up whenever :]</p>
            </div>
        ...
        <div class="mt-6 h-full">
            <nav class="overflow-x-auto [scrollbar-width:none]">
                <ul class="flex justify-end gap-8 text-sm min-w-max">
                    <li>
                        <a href="#">Posts</a>
                    </li>
                    <li>
        ...
        <ol class="pt-4 border-pixl-light/10 border-t">
            ...
            <li class="flex items-start gap-4 not-first:pt-2.5">
                <a href="/profile" class="shrink-0">
                    <img src="/images/michael.png" alt="Avatar for Michael"
                    ...
                    <div class="border-pixl-light/10 border-b pb-5">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-2.5">
                                <p><a class="hover:underline" href="/profile">Michael</a>
                                </p>
                                <p class="text-pixl-light/40 text-xs">3h</p>
                                <p>
                                    <a class="hover:text-pixl-light/60 text-pixl-light/40 text-xs"
                                        href="/profile">@mmich_jj</a>
                                </p>
                            </div>
                            <button class="group flex gap-[3px] py-2"
                        ...
                        <div
                            ...
                            <img src="/images/simon-chilling.png"
                                alt="Pixel art of Simon on hill" />
                        </div>
                        <!-- Action buttons -->
                                    ...
                                    <button aria-label="Save" class="hover:text-pixl">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g fill="currentColor" clip-path="url(#a)">
                                                ...
                                                <path
                                                    d="M4.636 15.454H3.091V17h1.545v-1.546Z" />
                                                <path
                                ...
                                <div class="flex items-center gap-1">
                                    <button aria-label="Share" class="hover:text-pixl">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g fill="currentColor" clip-path="url(#a)">
                                                <path
                                                    d="M2.125 6.375H0V8.5h2.125V6.375Z" />
                                                <path
                                                ...
                                                <path
                                                    d="M14.875 14.875H12.75V17h2.125v-2.125Z" />
                                                <path
                        ...
                        <!-- Reply form -->
                        <div
                            class="border-pixl-light/10 mt-8 flex items-start gap-4 border-t bg-pixl-light/3 p-4">
                            <a href="/profile" class="shrink-0">
                                <img src="/images/adrian.png" alt="Avatar for Adrian"
                                    class="size-10 object-cover" />
                            </a>
                            <form action="" class="grow">
                                <label class="sr-only" for="reply"></label>
                                <textarea class="w-full resize-none text-sm" rows="5"
                                    name="reply" id="reply"
                                        ...
                                        <button type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <g fill="#EEE" clip-path="url(#a)">
                                                    ...
                                                    <path
                                                        d="M1.598 14.25h-1.6v1.584h1.6V14.25Z" />
                                                    <path
                                                    ...
                                                    <path
                                                        d="M24.001 14.25h-1.6v1.584h1.6V14.25Z" />
                                                    <path
                                                    ...
                                                    <path
                                                        d="M19.196 17.418h-1.6V19h1.6v-1.583Z" />
                                                    <path
                                                    ...
                                                    <path
                                                        d="M9.598 6.333h-1.6v1.584h1.6V6.333Z" />
                                                </g>
                                                <defs>
                                                    <clipPath id="a">
                                                        <path fill="#fff"
                                        ...
                                        <button type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <g fill="#EEE" clip-path="url(#a)">
                                                    ...
                                                    <path
                                                        d="M6.403 17.417h-1.6V19h1.6v-1.583Z" />
                                                    <path
                                                    ...
                                                    <path
                                                        d="M19.203 17.417h-1.6V19h1.6v-1.583Z" />
                                                    <path
                                                        d="M20.8 17.417h-1.6V19h1.6v-1.583Z" />
                                                    <path
                    ...
                    <ol>
                        ...
                        <li class="relative flex items-start gap-4 pt-4 group/li">
                            ...
                            <div aria-hidden="true"
                                class="absolute top-0 left-5 w-px h-full group-last/li:h-4 bg-pixl-light/10">
                            </div>
                            <a href="/profile" class="shrink-0 isolate">
                                <img src="/images/calum.png" alt="Avatar for Calum"
                                    class="size-10 object-cover" />
                            </a>
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex items-center gap-2.5">
                                        <p><a class="hover:underline"
                                                href="/profile">Calum</a></p>
                                        <p class="text-pixl-light/40 text-xs">1h</p>
                                        <p>
                                            <a class="hover:text-pixl-light/60 text-pixl-light/40 text-xs"
                                                href="/profile">@ctforpresident</a>
                                        </p>
                                    </div>
                                    <button class="group flex gap-[3px] py-2"
                                        aria-label="Post options">
                                ...
                                <div class="mt-6 flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                class="text-pixl-light/40 text-sm">Save</span>
                                        </div>
                                        <!-- Share -->
                                        <div class="flex items-center gap-1">
    ...
    <aside class="my-4 hidden lg:block w-80 shrink-0 overflow-y-auto px-4 -mx-4">
        <input type="text" placeholder="#Search for an idea or pixel"
        ...
        <div class="border-pixl-light/10 mt-10 border p-4">
            ...
            <ol class="mt-4 flex flex-col gap-4">
                <li class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5">
                        <img src="/images/alessia.png" alt="Avatar of Alessia"
                ...
                <li class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5">
                        <img src="/images/anne.png" alt="Avatar of Anne"
                            class="size-8 object-cover" />
                ...
                <li class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5">
                        <img src="/images/mr-anderson.png" alt="Avatar of Mr. Anderson"
                            class="size-8 object-cover" />
                        <p class="truncate text-sm">mr_anderson</p>
                    </div>
                    <button
                        class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border-pixl/50 hover:border-pixl/60 active:border-pixl/75 text-pixl border px-2 py-1 text-sm">
                        Follow
                ...
                <li class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5">
                        <img src="/images/michael.png" alt="Avatar of Michael"
                            class="size-8 object-cover" />
